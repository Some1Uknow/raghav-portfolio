  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row lg:justify-start justify-start w-full lg:items-start items-center mt-20">
        <div className="text-5xl lg:text-8xl font-Bebas w-full lg:w-1/2 lg:ml-16 text-center lg:text-left">
          ABOUT ME
        </div>
        <div className="w-full lg:w-1/2 mt-8 lg:mt-0 px-4 lg:px-0">
          <MyComponent />
        </div>
      </div>
